...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	//좋아 나도 말 안하고 무조건 코딩으로 보여주지 
	// 대신 16 x 16 이상은 넘길수 없다. 
	...
	*/
	...
	m_tSecondSplitter.CreateStatic(&m_tMainSplitter, 2, 1, WS_VISIBLE | WS_CHILD, m_tMainSplitter.IdFromRowCol(0, 0));
	//m_tMainSplitter.CreateView(0, 0, RUNTIME_CLASS(CForm), CSize(300, 600), pContext);
